    ...
    <View style={styles.container}>
      ...
      <View style={styles.stateControls}>
        <TouchableOpacity style={styles.stateButton} onPress={toggleTheme}>
          <Text style={styles.stateButtonText}>Theme: {sharedState.theme}</Text>
        </TouchableOpacity>
      ...
      <View style={styles.pageInfo}>
        ...
        <Text style={styles.pageInfoText} numberOfLines={1}>
          URL:{" "}
          {navigationState.url || "device-dashboard.localhost:3010/embedded"}
        </Text>
        <Text style={styles.pageInfoText}>
          Navigation: Back({navigationState.canGoBack ? "✓" : "✗"}) | Forward(
